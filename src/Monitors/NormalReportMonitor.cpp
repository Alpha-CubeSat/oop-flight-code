...
void NormalReportMonitor::execute()
{
    ...
    std::map<uint8_t, uint8_t> report_contents = {
        ...
        {28, (fault_groups::power_faults::temp_c_value->serialize() << 4) + fault_groups::power_faults::temp_c_average->serialize()},
        {29, (fault_groups::power_faults::voltage_value->serialize() << 4) + fault_groups::power_faults::voltage_average->serialize()},
        {30, (fault_groups::power_faults::solar_current_average->serialize() << 4)},
