...
void NormalReportMonitor::execute()
{
    ...
    sfr::rockblock::report.push_back((uint8_t)sfr::mission::mode);
    ...
    sfr::rockblock::report.push_back(sfr::burnwire::armed_time);
    sfr::rockblock::report.push_back((uint8_t)sfr::burnwire::mode);
    sfr::rockblock::report.push_back(sfr::burnwire::attempts);
    sfr::rockblock::report.push_back(downlink_period);
    sfr::rockblock::report.push_back(sfr::rockblock::waiting_message);
    sfr::rockblock::report.push_back(sfr::rockblock::waiting_command);
    sfr::rockblock::report.push_back(mag_x);
    sfr::rockblock::report.push_back(mag_y);
    sfr::rockblock::report.push_back(mag_z);
    sfr::rockblock::report.push_back(gyro_x);
    sfr::rockblock::report.push_back(gyro_y);
    sfr::rockblock::report.push_back(gyro_z);
    sfr::rockblock::report.push_back(temp_c);
    // removed temperature mode type
    sfr::rockblock::report.push_back(solar_current);
    sfr::rockblock::report.push_back(sfr::current::in_sun);
    sfr::rockblock::report.push_back((uint8_t)sfr::acs::mode);
    sfr::rockblock::report.push_back(voltage);
    sfr::rockblock::report.push_back((uint8_t)sfr::fault::mode);
    sfr::rockblock::report.push_back(sfr::imu::mag_x_average->is_valid());
    sfr::rockblock::report.push_back(sfr::imu::mag_y_average->is_valid());
    sfr::rockblock::report.push_back(sfr::imu::mag_z_average->is_valid());
    sfr::rockblock::report.push_back(sfr::imu::gyro_x_average->is_valid());
    sfr::rockblock::report.push_back(sfr::imu::gyro_y_average->is_valid());
    sfr::rockblock::report.push_back(sfr::imu::gyro_z_average->is_valid());
    sfr::rockblock::report.push_back(sfr::temperature::temp_c_average->is_valid());
    sfr::rockblock::report.push_back(sfr::battery::voltage_average->is_valid());
