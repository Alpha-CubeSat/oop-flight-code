...
void NormalReportMonitor::execute()
{
    ...
    sfr::rockblock::normal_report[26] = sfr::fault::check_mag_x;
    sfr::rockblock::normal_report[27] = sfr::fault::check_mag_y;
    sfr::rockblock::normal_report[28] = sfr::fault::check_mag_z;
    sfr::rockblock::normal_report[29] = sfr::fault::check_gyro_x;
    sfr::rockblock::normal_report[30] = sfr::fault::check_gyro_y;
    sfr::rockblock::normal_report[31] = sfr::fault::check_gyro_z;
    sfr::rockblock::normal_report[32] = sfr::fault::check_temp_c;
    sfr::rockblock::normal_report[33] = sfr::fault::check_voltage;
    sfr::rockblock::normal_report[34] = sfr::fault::check_solar_current;
