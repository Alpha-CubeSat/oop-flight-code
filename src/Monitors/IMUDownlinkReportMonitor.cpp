...
void IMUDownlinkReportMonitor::execute()
{
    ...
    for (int idx = 0; idx < buffer_size; ++idx) {
        ...
        sfr::rockblock::imu_report[idx++] = magid_value;
        ...
        sfr::rockblock::imu_report[idx++] = gyro_x;
        ...
        sfr::rockblock::imu_report[idx++] = gyro_y;
        ...
        sfr::rockblock::imu_report[idx++] = gyro_z;
        ...
        sfr::rockblock::imu_report[idx++] = time_value;
    }
