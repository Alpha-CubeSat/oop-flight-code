...
namespace constants {
    ...
    namespace eeprom {
        ...
        static constexpr unsigned int burnwire_fire_offset = mission_already_deployed_offset + 4;
        static constexpr unsigned int burnwire_arm_offset = burnwire_fire_offset + 4;
        static constexpr unsigned int burnwire_attempts_offset = burnwire_arm_offset + 4;
        ...
        static constexpr unsigned int static_button_pressed_offset = battery_min_battery_offset + 6;

        static constexpr unsigned int eeprom_wait_time_last_write_time_offset = static_button_pressed_offset + 4;
