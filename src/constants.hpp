...
namespace constants {
    ...
    namespace rockblock {
        ...
        namespace opcodes {
            ...
            constexpr uint16_t temperature_mode[opcode_len] = {0x08, 0x00};

            // ACS Commands
            constexpr uint16_t acs_mode = 9;
            constexpr uint16_t change_simplified_acs = 10;                               //@Lauren is this needed? Or should this be renamed
            constexpr uint16_t request_imu_downlink_fragment[opcode_len] = {0x0D, 0x00}; // change
            ...
            // Fault Commands
            constexpr uint16_t fault_range_start = 65521;
            constexpr uint16_t fault_range_end = 65531;
            constexpr uint16_t fault_mode = 65521;
            constexpr uint16_t fault_check_mag_x = 65522;
            constexpr uint16_t fault_check_mag_y = 65523;
            constexpr uint16_t fault_check_mag_z = 65524;
            constexpr uint16_t fault_check_gyro_x = 65525;
            constexpr uint16_t fault_check_gyro_y = 65526;
            constexpr uint16_t fault_check_gyro_z = 65527;
            constexpr uint16_t fault_check_temp_c = 65528;
            constexpr uint16_t fault_check_solar_current = 65529;
            constexpr uint16_t fault_check_voltage = 65530;
        } // namespace opcodes
        // namespace rockblock
