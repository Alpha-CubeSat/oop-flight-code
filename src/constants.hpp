...
namespace constants {
    ...
    namespace acs {
        constexpr int xPWMpin = 6; //10 for EDU
        constexpr int yPWMpin = 10; //6 for EDU
        constexpr int zPWMpin = 30;

        constexpr int yout1 = 25; // 8 for EDU
        constexpr int yout2 = 24; // 7 for EDU

        constexpr int xout1 = 8; // 25 for EDU
        constexpr int xout2 = 7; // 24 for EDU
        ...
        // TODO:
        constexpr int xtorqorder = 1; // 0 for EDU
        constexpr int ytorqorder = 1; // 0 for EDU
        constexpr int ztorqorder = 1; // 0 for EDU

        // IMU Offset Coefficients

        // PWM fit coefficients
        // ex: pwmX_ox_1: coefficient for first degree term in pwmX_ox
        constexpr float pwmX_ox_1 = 5.72642735e-02;; // 5.21766488E-2 for EDU
        constexpr float pwmX_ox_2 = -3.32941558e-06; //-4.56157693E-6 for EDU
        constexpr float pwmX_ox_3 = 2.51577860e-09; // -2.10754381E-8 for EDU

        constexpr float pwmX_oy_1 = -1.05421663e-02; // -7.19251021E-03 for EDU
        constexpr float pwmX_oy_2 = 1.49763107e-05; // 1.28682985E-05 for EDU
        constexpr float pwmX_oy_3 = -4.08621328e-08; // 3.35875446E-09 for EDU

        constexpr float pwmX_oz_1 = 1.35291840e-03; // -8.09316675e-03 for EDU
        constexpr float pwmX_oz_2 = -4.21466668e-05; // -4.12199218e-05 for EDU
        constexpr float pwmX_oz_3 = -1.38842133e-08; // 1.88584179e-08 for EDU
        ///////////////////////////////
        constexpr float pwmY_ox_1 = -4.02597445e-02; // -2.10873715e-02 for EDU
        constexpr float pwmY_ox_2 = 2.63292003e-06; // -1.49983785e-06 for EDU 
        constexpr float pwmY_ox_3 = 3.38826965e-08; // -1.33605796e-08 for EDU

        constexpr float pwmY_oy_1 = -4.02597445e-02; //3.84524425e-02 for EDU
        constexpr float pwmY_oy_2 = 2.63292003e-06; // 1.70575989e-05 for EDU 
        constexpr float pwmY_oy_3 = 3.38826965e-08; // -3.42837575e-08 for EDU

        constexpr float pwmY_oz_1 = 5.44496439e-02; // 5.65194821e-02 for EDU
        constexpr float pwmY_oz_2 = -4.27335254e-05; // -6.21996583e-05 for EDU 
        constexpr float pwmY_oz_3 = 3.92358277e-08; // -7.88076518e-08 for EDU
        /////////////////////////////
        constexpr float pwmZ_ox_1 = 4.44822795e-02; // 3.86522925e-02 for EDU
        constexpr float pwmZ_ox_2 = -2.03606573e-06; // -3.27902806e-06 for EDU
        constexpr float pwmZ_ox_3 = -9.01969790e-09; // -1.52763483e-08 for EDU 

        constexpr float pwmZ_oy_1 = 7.50075982e-03; // 1.07442199e-02 for EDU
        constexpr float pwmZ_oy_2 = 2.31807375e-05; // 1.70881261e-05 for EDU
        constexpr float pwmZ_oy_3 = 6.45761942e-09; // 9.68654277e-09 for EDU

        constexpr float pwmZ_oz_1 = 1.50101720e-02; // 1.19418558e-02 for EDU
        constexpr float pwmZ_oz_2 = -4.75292304e-05; // -4.03330468e-05 for EDU
        constexpr float pwmZ_oz_3 = 2.72118450e-08; // -1.81032312e-08 for EDU
        ///////////////////////////
        ///////////////////////////
        ...
        // Hard Iron Offsets
        constexpr float hardiron_x = 21.463; // -4.150849999999998 for EDU
        constexpr float hardiron_y = 25.745; // 24.28385 for EDU
        constexpr float hardiron_z = -11.539; // 3.2226999999999997 for EDU
