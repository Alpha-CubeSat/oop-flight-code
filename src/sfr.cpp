...
namespace sfr {
    ...
    namespace rockblock {
        ...
        SFRField<uint32_t> lp_downlink_period = SFRField<uint32_t>(2 * constants::time::one_hour, constants::time::one_second, 2 * constants::time::one_day, 0x2110);
        ...
        // END TODO
        SFRField<uint32_t> on_time = SFRField<uint32_t>(20 * constants::time::one_minute, 0x2112);
    ...
    namespace acs {
        ...
        // TODO actual default value
        SFRField<uint32_t> on_time = SFRField<uint32_t>(20 * constants::time::one_minute, 0x2504);
