...
namespace sfr {
    ...
    namespace acs {
        ...
        SFRField<uint32_t> on_time = SFRField<uint32_t>(constants::time::one_minute, 0x2504);
    ...
    namespace eeprom {
        ...
        int sfr_last_write_cycle = 0; // the millis() value when the last EEPROM SFR data write ocurred, should reset every boot up cycle
