...
namespace sfr {
    ...
    namespace rockblock {
        ...
        SFRField<uint8_t> max_signal_check = SFRField<uint8_t>(12, 0x2105); //CHANGE 3 (BENSON): X4 MAX SIGNAL CHECK FROM 3 TO 12
        ...
        //CHANGE 2 (BENSON): TRANSMIT DOWNLINK PERIOD = 10 MINS INSTEAD OF 20.
        SFRField<uint32_t> transmit_downlink_period = SFRField<uint32_t>(10 * constants::time::one_minute, constants::time::one_second, 2 * constants::time::one_day, 0x2111);
