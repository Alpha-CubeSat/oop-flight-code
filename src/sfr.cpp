...
namespace sfr {
    ...
    namespace rockblock {
        ...
        // END TODO
        SFRField<uint32_t> on_time = SFRField<uint32_t>(30 * constants::time::one_minute, 0x2112);
    ...
    namespace acs {
        ...
        // TODO actual default value
        SFRField<uint32_t> on_time = SFRField<uint32_t>(10 * constants::time::one_minute, 0x2504);
